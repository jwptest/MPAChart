...
import com.finance.ben.OrderEntity;
 ...
 * 订单适配器
 */
public class OrderAdapter extends CDInvestmentBaseAdapter<OrderEntity.ItemEntity> implements StickyRecyclerHeadersAdapter<RecyclerView.ViewHolder> {
