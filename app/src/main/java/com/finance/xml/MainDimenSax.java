...
public class MainDimenSax {
    ...
    //默认支持的dp值
    private static final String[] defaultDPArr = new String[]{"360"};
    //去重复的数据集合
    ...
    public static void main(String[] args) {
        if (args == null || args.length == 0)
            args = new String[]{"375", "360", "375", "320", "390", "400", "420", "430", "440", "460", "480"};
        ...
        //获取当前目录的结对路径
        baseDirPath = new File("app/src/main/res").getAbsolutePath();
        //获取基准的dimens.xml文件
        baseDimenFilePath = baseDirPath + File.separator + "values/f_dimens.xml";
        ...
        if (list == null || list.size() <= 0) {
            System.out.println("DK WARNING:  \"../res/cd-resource/values/f_dimens.xml\" 文件无数据!");
            return;
        } else {
            System.out.println("OK \"../res/cd-resource/values/f_dimens.xml\" 基准dimens文件解析成功!");
        }
        ...
        while (iterator.hasNext()) {
            ...
            //待生成的dimens文件里路径
            String outPutFile = outPutDir + "f_dimens.xml";
