 ...
 * 绘制走势图控件
 */
public class MLineChartRenderer2 extends LineChartRenderer {

    public MLineChartRenderer2(LineDataProvider chart, ChartAnimator animator, ViewPortHandler viewPortHandler) {
