...
//        /*float phaseX = */
//        Math.max(0.f, Math.min(1.f, mAnimator.getPhaseX()));
...
//            int count;
////            int count1 = mXBounds.range + mXBounds.min;
...
////                count1 = mXBounds.range + mXBounds.min;
////                if (nextIndex == count1 - 1) {//倒数第二个
////                    nextIndex = count1;
////                    j = count1 + 1;
////                }
////                next = dataSet.getEntryForIndex(nextIndex);
////                if (next.getX() <= cur.getX() && nextIndex < count1) {
////                    continue;
////                }
////                if (next.getX() <= cur.getX() nextIndex) {
////                    continue;
////                }
//
