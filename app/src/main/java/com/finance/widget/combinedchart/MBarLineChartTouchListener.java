 ...
 * 事件处理
 */
public class MBarLineChartTouchListener extends ChartTouchListener<BarLineChartBase<? extends BarLineScatterCandleBubbleData<?
     ...
     */
    public MBarLineChartTouchListener(BarLineChartBase<? extends BarLineScatterCandleBubbleData<? extends
        ...
        if (event.getPointerCount() >= 2) { // two finger zoom
            ...
            if (totalDist > mMinScalePointerDistance) {
                ...
                if (mTouchMode == PINCH_ZOOM) {
                    ...
                    float scaleX = xDist / mSavedXDist / 2; // x-axis scale
