package com.finance.widget.roundview;
...
public class RoundViewDelegate {
    ...
    public void setCornerRadius(int cornerRadius_TL, int cornerRadius_TR, int cornerRadius_BL, int cornerRadius_BR, float cornerRadius, int backgroundColor) {
        this.cornerRadius_TL = cornerRadius_TL;
        this.cornerRadius_TR = cornerRadius_TR;
        this.cornerRadius_BL = cornerRadius_BL;
        this.cornerRadius_BR = cornerRadius_BR;
        this.backgroundColor = backgroundColor;
        this.cornerRadius = cornerRadius == 0 ? 0 : dp2px(cornerRadius);
        setBgSelector();
    }
