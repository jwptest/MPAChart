package com.finance.widget.indexrecyclerview.expandRecyclerviewadapter;
...
public interface StickyRecyclerHeadersAdapter<VH extends RecyclerView.ViewHolder> {
  ...
  /**
   * Creates a new ViewHolderNew for a header.  This works the same way onCreateViewHolder in
  ...
  /**
   * Binds an existing ViewHolderNew to the specified adapter position.
   *
   * @param holder
   * @param position
   */
